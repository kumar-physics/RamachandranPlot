...
#af data size 156,172,505
#pdb daa size 167,1056,79
...
if __name__ == "__main__":
    ...
    pdb_file = sys.argv[2]
    out_dir = sys.argv[3]
    calculate_density(af_file, pdb_file, out_dir)
    # calculate_density('/Users/kumaran/af_dihearal/af/af_test.csv', '/Users/kumaran/af_dihearal/pdb/pdb_test.csv',
    #                   '/Users/kumaran/af_dihearal/output')
